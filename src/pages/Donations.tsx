                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-100">
                      <th className="text-left px-6 py-4 text-gray-500 font-semibold text-xs whitespace-nowrap uppercase tracking-wider">Donor Name</th>
                      <th className="text-left px-6 py-4 text-gray-500 font-semibold text-xs whitespace-nowrap uppercase tracking-wider">Hospital</th>
                      <th className="text-left px-6 py-4 text-gray-500 font-semibold text-xs whitespace-nowrap uppercase tracking-wider">Appointment Time</th>
                      ...
                      <th className="text-left px-6 py-4 text-gray-500 font-semibold text-xs whitespace-nowrap uppercase tracking-wider">Units Donated</th>
                    ...
                    {filtered.map((item) => {
                      ...
                      return (
                        <tr key={appt.id} className="hover:bg-gray-50/60 transition-colors">
                          ...
                          <td className="px-6 py-4 text-gray-700 whitespace-nowrap">{hospital.name}</td>
